...
Taheri, M. A. (2006). *Cosmic Mysticism / Erfan-e-Kayhani (Halgheh)*. Persian edition. Publication details to be verified.

Taheri, M. A. (2007). *Human from Another Outlook*. Persian edition. Publication details to be verified.

Taheri, M. A. (2010). *The Relationship Between Ethics and Mysticism*. Persian edition. Publication details to be verified.

Taheri, M. A. (2011). *Human and Knowledge*. Persian edition. Publication details to be verified.

Taheri, M. A. (n.d.). *Halqeh Mysticism: Interuniversal Mysticism, Volume 1*. Interuniversal Press. Edition details to be verified.

Taheri, M. A. (n.d.). *Human Insight*. CreateSpace / Interuniversal Press. Edition details to be verified.

Taheri, M. A. (n.d.). *Human Worldview*. Interuniversal Press. Edition details to be verified.

Taheri, M. A. (n.d.). *Psymentology, Volume 1*. Publication details to be verified.

Taheri, M. A. (n.d.). *Nonorganic Viruses*. CreateSpace Independent Publishing Platform. Edition details to be verified.

Taheri, M. A. (n.d.). *Non-Organic Beings*. Interuniversal Press. Edition details to be verified.
